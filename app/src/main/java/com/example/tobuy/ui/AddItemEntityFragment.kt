...
class AddItemEntityFragment() : BaseFragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
       ...
       val categoriesViewStateEpoxyController = CategoriesViewStateEpoxyController{categoryId ->
        ...
        sharedViewModel.onCategorySelected(selectedItemEntity?.categoryId ?: CategoryEntity.Default_VAL, showLoading = true)
   ...
   //     super.onPause()
     ...
     private fun saveItemEntityToDatabase() {
        ...
        val itemPriority = when(binding.RadioGroup.checkedRadioButtonId){
         ...
         val getCategoryId = sharedViewModel.categoriesViewStateLiveData.value?.getSelectedCategoryId() ?: return
         if (inEditMode){
